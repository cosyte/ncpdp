...
Trading partners impose network-specific conventions on NCPDP traffic. A profile records whose
conventions it accommodates, which cannot be said without naming them.

Every reference is **descriptive**: it identifies whose trading-partner conventions a profile accommodates, and nothing more. Naming a system is the only way to say
...
publicly available specifications. They are descriptive only: selecting a profile never changes a
correct parse. They embed no privileged, confidential, or reverse-engineered material.
