...
the **version bump** and **publish** for `@cosyte/ncpdp`; the human-readable release notes live in
...
During pre-alpha, pick **patch**, which keeps the package on the `0.0.x` ladder until its first
