...
/** Every backtick-quoted literal in a snippet that holds a SCRIPT message. */
export function messageLiterals(code: string): string[] {
  const literals: string[] = [];
  for (const match of code.matchAll(/`([^`]*<Message\b[^`]*)`/g)) {
...
/** Every module specifier a snippet imports from, in source order. */
